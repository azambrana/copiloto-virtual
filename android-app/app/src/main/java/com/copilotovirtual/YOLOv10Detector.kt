...
class YOLOv10Detector(
    ...
    private fun bestBox(array: FloatArray) : List<BoundingBoxYOLOv10> {
        val boundingBoxes = mutableListOf<BoundingBoxYOLOv10>()
    ...
    interface DetectorListener {
        fun onEmptyDetect()
        fun onDetect(BoundingBoxYOLOv10es: List<BoundingBoxYOLOv10>, inferenceTime: Long)
    }
